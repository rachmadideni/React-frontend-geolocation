...
class Sungai extends React.Component {
    ...
    render() {
        const { data, DASMode, isLoading, errorMessage, getRiverFailed, snackBarState, setSnackbar } = this.props
...
function mapDispatchToProps(dispatch) {
    return {
        ...
        changeDasInnerTabValue: value => dispatch(changeDasInnerTabValueAction(value)),
