...
import { Source, Layer, Popup } from '@urbica/react-map-gl'
...
class BatasKecamatan extends React.Component {
  ...
  displayDialog() {
    const { longitude, latitude, nama_kec } = this.state
    return (
      <Popup
        longitude={longitude}
        latitude={latitude}
  ...
  render() {
    ...
    return (
      <React.Fragment>
        <Source id="batas_kecamatan" type="geojson" data={BATAS_KECAMATAN} />
