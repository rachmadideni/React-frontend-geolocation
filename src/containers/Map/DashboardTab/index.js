				...
				<Grid 
					...
					<form 
				        ...
				        <TextField
				          ...
				          label="Nama Project"			          
				          value={namaProject}
				          onChange={e=>this.handleTextChange('namaProject',e.target.value)}
				          margin="normal"
				          fullWidth
				          style = {{
				          	fontSize:14
				        ...
				        <TextField
				          ...
				          label="Keterangan"			          
				          value={keterangan}
				          onChange={e=>this.handleTextChange('keterangan',e.target.value)}
				          margin="normal"
				          fullWidth
				          multiline
				          rows={4}
						...
						<Button 
							...
							fullWidth
							onClick={
								this.handleOpenUploadDialog.bind(this)
							}
							style={{
								marginBottom:15
							}}>
				        ...
				        <Button 
					      ...
					      <DatePicker
					          ...
					          cancelText={'BATAL'}
					          onSelect={value => {					            
					            this.handleTextChange('tahunProject',moment(value).format('YYYY'));					            
