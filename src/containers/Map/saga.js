...
export function* updateRiverProperty(action) {
  try {
    ...
    if (err) yield put(updateRiverPropertyErrorAction())
  }
}
...
export function* getProject() {
  ...
  try {
    ...
    yield put(
      getProjectFailedAction('Terjadi error saat mengambil data project!')
    )
  }
}
...
export function* loadProject() {
  ...
  try {
    ...
    yield put(
      loadProjectErrorAction('Terjadi error saat mengambil data project!')
    )
  }
}
...
export function* fetchRiverAttribute(action) {
  ...
  try {
    ...
    const keterangan = response.data[0].keterangan
      ? response.data[0].keterangan
      : ''
