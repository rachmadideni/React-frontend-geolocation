...
function mapContainerReducer(state = initialState, action) {
  switch (action.type) {
    ...
    case GET_RIVER_SUCCESS_ACTION: {
      return state
        .set('loading', false)
        .setIn(['geodata', 'river', 'features'], new List(action.payload))
    ...
    case INSERT_RIVER_FEATURES:
      return state
        .set('loading', true)
        .updateIn(['geodata', 'river', 'features'], (features) =>
          features.push(action.payload)
        )
    ...
    case INSERT_PROJECT_FEATURES_ACTION:
      return state
        .set('loading', true)
        .updateIn(['geodata', 'project', 'features'], (features) =>
          features.push(action.payload)
        )
    ...
    case QUERY_PROPERTI_SUCCESS_ACTION:
      return state
        .set('loading', false)
        .setIn(['queryProperti'], new Map(action.payload))
    ...
    case UPDATE_FEATURES_ACTION: {
      ...
      return state.updateIn(['updatedFeatures'], (id) =>
    ...
    case GET_PROJECT_SUCCESS_ACTION: {
      return state
        .set('loading', false)
        .setIn(['geodata', 'project', 'features'], new List(action.payload))
    }
    ...
    case GET_PROJECT_PROPERTIES_SUCCESS_ACTION:
      return state
        .set('loading', false)
        .setIn(['form', 'project'], new Map(action.payload))
