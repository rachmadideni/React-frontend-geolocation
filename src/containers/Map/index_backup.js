...
class MapContainer extends React.Component {
  ...
  _callDrawProject = () => {
    ...
    if (layerVisibility.project) {
      return (
        <ProjectMark data={geodataProject} riverData={this.props.geodata} />
      )
    } else if (layerVisibility.sungai) {
      return (
        <RiverMap data={this.props.geodata} fetchRiver={this.props.getRiver} />
      )
    }
  }
...
export default compose(withReducer, withSaga, withConnect)(MapContainer)
