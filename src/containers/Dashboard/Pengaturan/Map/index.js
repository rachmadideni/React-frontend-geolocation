...
class PengaturanMap extends React.Component {
  ...
  handleLayerVisibility = () => {
    const { checkedKecamatan, checkedSungai, checkedProject } = this.state
...
function mapDispatchToProps(dispatch) {
  return {
    ...
    changeLayerVisibility: ({ kecamatan, sungai, project }) =>
      dispatch(changeLayerVisibilityAction({ kecamatan, sungai, project })),
  }
}
